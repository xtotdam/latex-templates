...
\usepackage{scrtime}
\newcommand{\praiseme}[1]{\scalebox{.4}{ \textcircled{\scalebox{.5}{CC}} \textcircled{\scalebox{.5}{BY}} \textcircled{\scalebox{.5}{SA}} #1, \the\day.\the\month.\the\year\textunderscore\thistime*}} % useful for copyright. Right there CC-BY-SA license

\newcommand{\tobewritten}[0]{\textcolor{red}{\textsc{To be written}}}
\newcommand{\NB}[0]{\textbf{NB!}}
\newcommand{\NBtoc}[0]{\addcontentsline{toc}{section}{NB!!!}\textbf{NB!}}   % also adds NB! to table of contents
